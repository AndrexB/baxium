...
This guide describes how to build baxiumd, command-line utilities, and GUI on FreeBSD.
...
#### Wallet Dependencies
It is not necessary to build wallet functionality to run either `baxiumd` or `bitcoin-qt`.

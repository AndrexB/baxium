...
This guide describes how to build baxiumd, command-line utilities, and GUI on NetBSD.
...
It is not necessary to build wallet functionality to run baxiumd or the GUI.
